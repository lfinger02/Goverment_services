...
if (answerCorrection::ft_grade_user($a1_3_1, $a1_3_1_A, 1) == 1)
{
      echo "
   <script>
   $('#1_3_1').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_3_2, $a1_3_2_A, 1) == 1)
{
      echo "
   <script>
   $('#1_3_2').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_3_3, $a1_3_3_A, 1) == 1)
{
      echo "
   <script>
   $('#1_3_3').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_3_4, $a1_3_4_A, 1) == 1)
{
      echo "
   <script>
   $('#1_3_4').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_3_5, $a1_3_5_A, 1) == 1)
{
      echo "
   <script>
   $('#1_3_5').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_3_6, $a1_3_6_A, 1) == 1)
{
      echo "
   <script>
   $('#1_3_6').after(' ✔✔');
...
$totalMarkPercengtage = round($totalMarksAttained / 30 * 100, 0);
...
<div class='modal-body'>
        ...
        <div class='totalMark'><b>TOTAL</b> : ";echo passShower($totalMarksAttained, 30); echo " / 30</div>
