...
$a1_1_8 = strtoupper($_POST['a1_1_8']);
$a1_1_9 = strtoupper($_POST['a1_1_9']);
$a1_1_10 = strtoupper($_POST['a1_1_10']);
...
$a1_2_9 = strtoupper($_POST['a1_2_9']);
$a1_2_10 = strtoupper($_POST['a1_2_10']);
...
$a1_3_6 = strtoupper($_POST['a1_3_6']);
...
$a1_1_8_A = strtoupper($_POST['a1_1_8_A']);
$a1_1_9_A = strtoupper($_POST['a1_1_9_A']);
$a1_1_10_A = strtoupper($_POST['a1_1_10_A']);
...
$a1_2_9_A = strtoupper($_POST['a1_2_9_A']);
$a1_2_10_A = strtoupper($_POST['a1_2_10_A']);
...
$a1_3_6_A = strtoupper($_POST['a1_3_6_A']);
...
if ($a1_1_8 == $a1_1_8_A)
{
	...
	<script>
	$('#1_1_8').after(' ✔✔');
	$('#1_1_8').css('border', '2px solid #4CAF50');
	</script>
	";
...
else
{
	echo "
	<script>
	$('#1_1_8').after(' ✘✘<br> Correct is : <b>$a1_1_8_A</b>');
	$('#1_1_8').css('border', '2px solid #f44336');
	</script>
	";
...
if ($a1_1_9 == $a1_1_9_A)
{
	...
	<script>
	$('#1_1_9').after(' ✔✔');
	$('#1_1_9').css('border', '2px solid #4CAF50');
	</script>
	";
...
else
{
	echo "
	<script>
	$('#1_1_9').after(' ✘✘<br> Correct is : <b>$a1_1_9_A</b>');
	$('#1_1_9').css('border', '2px solid #f44336');
	</script>
	";

}

if ($a1_1_10 == $a1_1_10_A)
{
	echo "
	<script>
	$('#1_1_10').after(' ✔✔');
	$('#1_1_10').css('border', '2px solid #4CAF50');
	</script>
	";
	$correct_Q1+=$mark;
}
else
{
	echo "
	<script>
	$('#1_1_10').after(' ✘✘<br> Correct is : <b>$a1_1_10_A</b>');
	$('#1_1_10').css('border', '2px solid #f44336');
	</script>
	";
}

if (answerCorrection::ft_grade_user($a1_2_1, $a1_2_1_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_1').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_2_2, $a1_2_2_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_2').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_2_3, $a1_2_3_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_3').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_2_4, $a1_2_4_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_4').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_2_5, $a1_2_5_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_5').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_2_6, $a1_2_6_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_6').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_2_7, $a1_2_7_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_7').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_2_8, $a1_2_8_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_8').after(' ✔✔');
...
if (answerCorrection::ft_grade_user($a1_2_9, $a1_2_9_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_9').after(' ✔✔');
	$('#1_2_9').css('border', '2px solid #4CAF50');
	</script>
	";
	$correct_Q2+=$mark;
}
else
{
	echo "
	<script>
	$('#1_2_9').after(' ✘✘<br> Correct is : <b>$a1_2_9_A</b>');
	$('#1_2_9').css('border', '2px solid #f44336');
	</script>
	";
}

if (answerCorrection::ft_grade_user($a1_2_10, $a1_2_10_A, 2) == 2)
{
		echo "
	<script>
	$('#1_2_10').after(' ✔✔');
	$('#1_2_10').css('border', '2px solid #4CAF50');
	</script>
	";
	$correct_Q2+=$mark;
}
else
{
	echo "
	<script>
	$('#1_2_10').after(' ✘✘<br> Correct is : <b>$a1_2_10_A</b>');
	$('#1_2_10').css('border', '2px solid #f44336');
	</script>
	";
}
...
if ($a1_3_6 == $a1_3_6_A)
{
	...
	<script>
	$('#1_3_6').after(' ✔✔');
	$('#1_3_6').css('border', '2px solid #4CAF50');
	</script>
	";
...
else
{
	echo "
	<script>
	$('#1_3_6').after(' ✘✘<br> Correct is : <b>$a1_3_6_A</b>');
	$('#1_3_6').css('border', '2px solid #f44336');
	</script>
	";
