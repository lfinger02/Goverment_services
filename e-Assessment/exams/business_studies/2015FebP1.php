   ...
   <body>
      <div class="e-exam_header">
         ...
         <div class="exam_beginWritten">
            February & March 2015 Business Studies P1
         </div>
      </div>
         ...
         <div class="question_container">
            <div class="question_paper">
               ...
               <div class="Question_section">
                  <div class="Question">
                     <b>1.1.1</b> A function of a SETA is to ...
                  </div>
                  <div class="Question_options">
                     <b>A</b> register procurement contracts.
                     <br>
                     <b>B</b> promote employees to senior positions.
                     <br>
                     <b>C</b> develop a management plan.
                     <br>
                     <b>D</b> register learnership agreements.
                  </div>
            ...
            <div class="question_paper">
               ...
               <div class="abbreviation_selection">
                  primary; human resources; quality control; grievance;
                  quality assurance; UIF; tertiary; RAF; conflict; National Skills
               </div>
               <div class="Question">
                  <b>1.2.1</b> The 
                  <input class="abbreviation_input" type="text" id="1_2_1"><input class="hidden_Answer" type="text" value="human" id="1_2_1_A"> compensates someone injured in a motor vehicle accident
                  whether or not he/she was part of the cause of the accident.
               </div>
               <div class="Question">
                  <b>1.2.2</b> The 
                  <input class="abbreviation_input" type="text" id="1_2_2"><input class="hidden_Answer" type="text" value="D" id="1_2_2_A"> sector includes all industries that offer services to other
               ...
               <img class="question_image" src="images/2015Feb1/1.3.PNG">
